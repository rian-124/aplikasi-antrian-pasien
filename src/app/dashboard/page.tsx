...
export default function DashboardPage() {
  ...
  const fetchPatients = async (source: "all" | "daily" = dataSource) => {
    try {
      ...
      const apiUrl =
        source === "all"
          ? "http://192.168.50.222:4000/api/antrian-pasien/user"
          : "http://192.168.50.222:4000/api/antrian-pasien/user/daily";
  ...
  const fetchRecap = async () => {
    try {
      ...
      const res = await fetch(
        "http://192.168.50.222:4000/api/antrian-pasien/user/recap",
        {
